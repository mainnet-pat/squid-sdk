...
import { array, NAT, object, } from '@subsquid/util-internal-validation';
import { getBlockHeaderProps, getTxProps } from '../mapping/schema.js';
...
export const getBlockValidator = weakMemo((req) => {
