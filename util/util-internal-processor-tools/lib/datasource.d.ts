...
export interface HotDataSource<B, R> extends DataSource<B, R> {
    processHotBlocks(requests: RangeRequestList<R>, state: HotDatabaseState, cb: (upd: HotUpdate<B>) => Promise<void>): Promise<void>;
    processMempool?(requests: RangeRequestList<R>, state: HotDatabaseState, cb: (upd: HotUpdate<B>) => Promise<void>): Promise<() => Promise<void>>;
}
